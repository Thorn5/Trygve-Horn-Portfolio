...
export const FetchApiData = () => {
    ...
    const fetchRealData = () => {
        ...
        sessionStorage.setItem("timeAtFetch", new Date());
        sessionStorage.setItem("API Call", "Real Data");
    };
    ...
    const fetchMockData = () => {
        ...
        const timer = setTimeout(() => {
            ...
            sessionStorage.setItem("weatherData", weatherDataStringify);
            sessionStorage.setItem("weatherData_de", weatherData_de_Stringify);
            sessionStorage.setItem("API Call", "Mocked Data");
    ...
    return {
        apiLoading: loading,
        apiErrorEnglishIp: errorEnglishIp,
        apiErrorGermanIp: errorGermanIp,
        apiErrorEnglishWeather: errorEnglishWeather,
        apiErrorGermanWeather: errorGermanWeather,
        apiIpData: ipData,
        apiIpData_de: ipData_de,
        apiWeatherData: weatherData,
        apiWeatherData_de: weatherData_de,
    };
};
